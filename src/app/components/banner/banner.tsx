        ...
        <div className="flex flex-row md:pl-4">
            <div className="flex flex-col justify-center">
                ...
                <div className="flex text-center md:text-left">
                    <p className="text-sm md:text-lg text-stone-500 dark:text-stone-400 my-6">Nuestros cursos subvencionados están financiados por todas las entidades estatales (FUNDAE, Consorcio, Cámara de comercio...), lo que significa que puedes acceder a formación de calidad sin ningún coste por tu parte. Ofrecemos una amplia gama de cursos diseñados para mejorar tus habilidades, actualizar tus conocimientos y abrir nuevas oportunidades laborales. Ya seas un trabajador activo, autónomo o desempleado, tenemos un curso para ti.</p>
                </div>
            ...
            <div className="hidden md:flex">
                <Image src={`/imgs/banner/banner_sepe.png`} width={'1920'} height={'1080'} alt=""></Image>
            </div>
        </div>
    );
}